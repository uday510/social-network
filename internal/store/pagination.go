...
type PaginatedFeedQuery struct {
	Limit  int      `json:"limit"  validate:"gte=1,lte=20"`   // Enforces 1 ≤ Limit ≤ 20
	Offset int      `json:"offset" validate:"gte=0"`          // Must be ≥ 0
	Sort   string   `json:"sort"   validate:"oneof=asc desc"` // Only "asc" or "des" allowed
